...
<!--medical database-->
<svg fill="#FFFFFF" width="50pt" height="50pt" version="1.1" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
...
<a class="footer-link" href="http://silviacanelon.com/2022-tdw-ehr-lessons"><strong>slides.silviacanelon/2022-tdw-ehr-lessons</strong>
...
<span role="img" aria-label="Process diagram describing the steps our algorithm takes to identify patients with deliveries within the Electronic Health Record dataset. The algorithm uses unique patient identifiers, dates of encounter with a Penn Medicine clinic, ICD codes, and temporal information to extract delivery episode details."></span>
...
.footnote[
[Development and evaluation of MADDIE: Method to Acquire<br> Delivery Date Information from Electronic health records](https://www-sciencedirect-com.proxy.library.upenn.edu/science/article/pii/S1386505620309588?via%3Dihub)
]
...
- We should be left with patients with fallopian tube procedures in our records, but they are missing 🤔
...
--
**Cuprit:** Excel cut off the trailing zero from all codes in the spreadsheet!
...
**Culprit:** [A change in<br> ICD coding practices!](https://www.cmqcc.org/sites/default/files/AIM-SMM-Data-Alert-Blood-Transfusions-v4-15-2016%20%284%29.pdf)
...
- Childrens' data is protected
--

- Even after anonymizing data, reidentification is possible: [You’re very easy to track down, even when your data has been anonymized | MIT Technology Review](https://www.technologyreview.com/2019/07/23/134090/youre-very-easy-to-track-down-even-when-your-data-has-been-anonymized/)
--
...
- Sometimes when studying OUD and opioid prescription patterns a lot of information is scrubbed from the clinical notes, perhaps for political reasons
...
.pull-left-equal[
> If you're interested in learning more about EHR data:

> - [Toronto Data Workshop - Irene Duah-Kessie](https://www.youtube.com/watch?v=xwWvOeSXu5o)
]
--
.pull-right-equal[
